...
export const projectsData = [
  {
    ...
    badgePill: "Best Web App - DevFest 2024",
    bannerTitle: "Momoped Pet Shop Platform",
    ...
    isFeatured: true,
    github: "https://github.com/workhendry20-creator",
    repoUrl: "https://github.com/workhendry20-creator",
    liveDemo: "https://workhendry20-creator.github.io/my-portofolio/",
    demoUrl: "https://workhendry20-creator.github.io/my-portofolio/",
  ...
  },
  {
    ...
    badgePill: "USM International Research",
    bannerTitle: "Computer Vision & Physics Engine",
  ...
  },
  {
    ...
    badgePill: "Startup & MSME Empowerment",
    bannerTitle: "Webtizen.id Platform",
  ...
  },
  {
    ...
    category: "data",
    categoryLabel: "Kaggle & AWS Certified ML",
    badgePill: "Kaggle & AWS Certified ML",
    bannerTitle: "ML Predictive Analytics Pipeline",
    ...
    bannerGradient: "from-amber-500 via-amber-600 to-amber-700",
    featured: false,
    isFeatured: false,
    github: "https://github.com/workhendry20-creator",
    repoUrl: "https://github.com/workhendry20-creator",
  ...
  },
  {
    id: "usm-physx-lab",
    category: "research",
    categoryLabel: "Computational Physics Research",
    badgePill: "Computational Physics Research",
    bannerTitle: "USM PhysX Lab - Web Physics Engine",
    imageGradient: "linear-gradient(135deg, #4f46e5 0%, #9333ea 50%, #ec4899 100%)",
    bannerGradient: "from-indigo-600 via-purple-600 to-pink-500",
    featured: true,
    isFeatured: true,
    title: "USM PhysX Lab - Interactive Web Physics Engine",
    summary: "Interactive physics simulation engine built with HTML5 Canvas & JS, designed during research at USM to simulate dynamic physical phenomena in real-time.",
    description: "Interactive physics simulation engine built with HTML5 Canvas & JS, designed during research at USM to simulate dynamic physical phenomena in real-time.",
    tags: ["Computational Physics", "JavaScript", "HTML5 Canvas", "Mathematical Modeling"],
    github: "https://github.com/workhendry20-creator/usm-physx-lab.git",
    repoUrl: "https://github.com/workhendry20-creator/usm-physx-lab.git",
    liveDemo: "https://workhendry20-creator.github.io/usm-physx-lab",
    demoUrl: "https://workhendry20-creator.github.io/usm-physx-lab",
    metrics: ["🔬 USM Computational Physics", "⚡ Real-time Canvas Simulation"]
  },
  {
    id: "research-highlight-builder",
    category: "research",
    categoryLabel: "Research Data Systems",
    badgePill: "Research Data Systems",
    bannerTitle: "Research Highlight Builder",
    imageGradient: "linear-gradient(135deg, #f59e0b 0%, #ea580c 50%, #dc2626 100%)",
    bannerGradient: "from-amber-500 via-orange-500 to-red-600",
    featured: false,
    isFeatured: false,
    title: "Research Highlight Builder",
    summary: "Interactive system designed to structure, format, and standardize complex academic data and scientific highlights into readable, production-ready documentation.",
    description: "Interactive system designed to structure, format, and standardize complex academic data and scientific highlights into readable, production-ready documentation.",
    tags: ["React", "Data Structuring", "Tailwind CSS", "Academic Systems"],
    github: "https://github.com/workhendry20-creator/research-highlight-builder",
    repoUrl: "https://github.com/workhendry20-creator/research-highlight-builder",
    liveDemo: "https://workhendry20-creator.github.io/research-highlight-builder",
    demoUrl: "https://workhendry20-creator.github.io/research-highlight-builder",
    metrics: ["📊 Academic Data Formatting", "⚡ Production-Ready Docs"]
  },
  {
    id: "sitka-frontend",
    category: "web",
    categoryLabel: "Software Engineering UI",
    badgePill: "Software Engineering UI",
    bannerTitle: "SITKA Integrated System UI",
    imageGradient: "linear-gradient(135deg, #2563eb 0%, #4f46e5 50%, #6b21a8 100%)",
    bannerGradient: "from-blue-600 via-indigo-600 to-purple-700",
    featured: false,
    isFeatured: false,
    title: "SITKA - Integrated Information System Frontend",
    summary: "High-performance frontend architecture featuring data-driven dashboards, dynamic state management, and optimized REST API integration.",
    description: "High-performance frontend architecture featuring data-driven dashboards, dynamic state management, and optimized REST API integration.",
    tags: ["React.js", "Vite", "REST API", "System Architecture"],
    github: "https://github.com/workhendry20-creator/sitka-frontend.git",
    repoUrl: "https://github.com/workhendry20-creator/sitka-frontend.git",
    liveDemo: null,
    demoUrl: null,
    metrics: ["🚀 High-Performance Dashboards", "🔌 REST API Integration"]
  },
  {
    id: "myr-ledger",
    category: "data",
    categoryLabel: "Financial Data Analytics",
    badgePill: "Financial Data Analytics",
    bannerTitle: "MYR Ledger Financial System",
    imageGradient: "linear-gradient(135deg, #10b981 0%, #16a34a 50%, #0f766e 100%)",
    bannerGradient: "from-emerald-500 via-green-600 to-teal-700",
    featured: false,
    isFeatured: false,
    title: "MYR Ledger - Financial Data System",
    summary: "Financial tracking and ledger system engineered to capture transactions, categorize expenditures, and generate accurate data visualizations for cash flow analysis.",
    description: "Financial tracking and ledger system engineered to capture transactions, categorize expenditures, and generate accurate data visualizations for cash flow analysis.",
    tags: ["Data Analytics", "Financial Modeling", "JavaScript", "React"],
    github: "https://github.com/workhendry20-creator/myr-ledger.git",
    repoUrl: "https://github.com/workhendry20-creator/myr-ledger.git",
    liveDemo: null,
    demoUrl: null,
    metrics: ["📈 Financial Cash Flow Analytics", "💳 Ledger Tracking"]
  },
  {
    id: "workspace-manager",
    category: "web",
    categoryLabel: "Productivity Engineering",
    badgePill: "Productivity Engineering",
    bannerTitle: "Workspace Manager Platform",
    imageGradient: "linear-gradient(135deg, #38bdf8 0%, #3b82f6 50%, #6366f1 100%)",
    bannerGradient: "from-sky-400 via-blue-500 to-indigo-500",
    featured: false,
    isFeatured: false,
    title: "Workspace Manager",
    summary: "Digital workspace management system engineered to streamline productivity workflows and structure project data pipelines through an intuitive interface.",
    description: "Digital workspace management system engineered to streamline productivity workflows and structure project data pipelines through an intuitive interface.",
    tags: ["React.js", "Productivity System", "State Management", "UI/UX"],
    github: "https://github.com/workhendry20-creator/workspace-manager.git",
    repoUrl: "https://github.com/workhendry20-creator/workspace-manager.git",
    liveDemo: null,
    demoUrl: null,
    metrics: ["⚡ Productivity Workflows", "🗂 Data Pipeline Management"]
  },
  {
    id: "spider-sense-memory-quest",
    category: "web",
    categoryLabel: "Interactive Algorithmic App",
    badgePill: "Interactive Algorithmic App",
    bannerTitle: "Spider-Sense Memory Quest",
    imageGradient: "linear-gradient(135deg, #ef4444 0%, #e11d48 50%, #7e22ce 100%)",
    bannerGradient: "from-red-500 via-rose-600 to-purple-700",
    featured: false,
    isFeatured: false,
    title: "Spider-Sense Memory Quest",
    summary: "Interactive logic-driven web application designed around memory algorithms, dynamic state handling, and responsive user interaction patterns.",
    description: "Interactive logic-driven web application designed around memory algorithms, dynamic state handling, and responsive user interaction patterns.",
    tags: ["JavaScript", "Algorithm Logic", "State Management", "CSS Animation"],
    github: "https://github.com/workhendry20-creator/spider-sense-memory-quest.git",
    repoUrl: "https://github.com/workhendry20-creator/spider-sense-memory-quest.git",
    liveDemo: "https://workhendry20-creator.github.io/spider-sense-memory-quest",
    demoUrl: "https://workhendry20-creator.github.io/spider-sense-memory-quest",
    metrics: ["🧠 Algorithmic Memory Logic", "🎮 Interactive UI State"]
  }
];
