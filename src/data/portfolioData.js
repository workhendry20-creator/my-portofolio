...
export const certificationsData = [
  ...
  {
    id: "kaggle-ds",
    title: "Kaggle Data Science & ML Certification",
    issuer: "Kaggle / Google",
    year: "2024",
    badge: "Kaggle Verified 🏅",
    category: "Data Science",
    credentialId: "KAG-DS-ML-2024",
    image: "./assests/kaggle.png",
    imageGradient: "linear-gradient(135deg, #20BEFF 0%, #0088CC 50%, #005588 100%)",
    description: "Certification in advanced data manipulation, machine learning modeling, feature engineering, and competitive data analysis on Kaggle.",
    skills: ["Kaggle", "Machine Learning", "Python", "Data Analysis"]
  },
  {
    id: "revou-tech",
    title: "RevoU Digital Tech & Software Fundamentals",
    issuer: "RevoU Academy",
    year: "2024",
    badge: "RevoU Certified 🚀",
    category: "Tech & Software",
    credentialId: "REVOU-TECH-2024",
    image: "./assests/revou.jpeg",
    imageGradient: "linear-gradient(135deg, #FF3366 0%, #CC0033 50%, #990022 100%)",
    description: "Certification in digital software development workflows, business analytics, growth strategy, and digital product execution.",
    skills: ["Digital Tech", "Software Workflows", "Product Analytics", "Growth Strategy"]
  },
  {
    id: "waste-tech",
    title: "Environmental & Scientific Research Tech",
    issuer: "Research & Academic Forum",
    year: "2024",
    badge: "Research Cert 🔬",
    category: "Scientific Research",
    credentialId: "RESE-WASTE-2024",
    image: "./assests/waste.jpeg",
    imageGradient: "linear-gradient(135deg, #10B981 0%, #047857 50%, #065F46 100%)",
    description: "Scientific certification in environmental data analysis, sustainability tech modeling, and experimental data collection.",
    skills: ["Scientific Research", "Data Analytics", "Environmental Tech", "Experimental Modeling"]
  },
  {
    id: "devfest-cert",
